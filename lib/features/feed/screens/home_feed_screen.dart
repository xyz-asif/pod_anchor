...
class _HomeFeedScreenState extends ConsumerState<HomeFeedScreen> {
  ...
  @override
  Widget build(BuildContext context) {
    // FIX: Watch the unread notification count for the badge
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          // FIX: Notification icon with unread badge
          Stack(
                  ...
                  child: state.when(
                    ...
                    data: (poems) {
                      ...
                      return ListView.builder(
                        physics: const AlwaysScrollableScrollPhysics(),
                        key: PageStorageKey(
                          _showAudioOnly ? 'audio_feed' : 'all_feed',
                        ),
                        controller: _activeController,
                        itemCount: poems.length,
                        itemBuilder: (_, i) {
